...
namespace Direct3D12
{
    ...
    struct D3D12PipelineStateSubobjectStream()
    {
        ...
        public PipelineStateSubObjectTypePrimitiveTopology PrimitiveTopology = new(PrimitiveTopologyType.Undefined);
        public PipelineStateSubObjectTypeRenderTargetFormats RenderTargetFormats = new([]);
        public PipelineStateSubObjectTypeDepthStencilFormat DepthStencilFormat = new(Format.Unknown);
